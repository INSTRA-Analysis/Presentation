...
def plot_SDOF_forces():
    ...
    radius = 0.08
    circle1 = plt.Circle((-0.71, -0.71), radius, color='red', fill=False, linewidth=2)
    circle2 = plt.Circle((0.71, -0.71), radius, color='red', fill=False, linewidth=2)
...
###########################################################
# Plot a signgle degree of freedom system (SDOF) schematic with forces only
###########################################################
